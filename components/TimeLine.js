      ...
      <main className='justify-center svg-animation'>
        ...
        <div className="image-wrapper md:grid items-center justify-items-center grid-rows-3 grid-cols-2 w-full text-center h-full mb-32">
          ...
          <div className="mb-10 lg:mb-0 timeCard timeCard1 scroll w-full" data-rate='-0.1' data-direction='horizontal'>
            <Image
              src="/assets/images/Photos cabinet/DSCF8496.jpg"
              alt="Oser"
            ...
            />
            <p className="text-lg md:text-xl lg:text-2xl font-normal leading-1 tracking-tight text-gray-900 text-justify px-3 lg:px-0 lg:pr-5 mb-8 mt-5 text-wrap"><strong className='text-custom-purple font-bold'>Oser</strong> défendre sa place ou son entreprise. <strong className='text-custom-purple font-bold'>Oser</strong> poser des limites. Dans le monde du travail, chaque décision compte. Nous vous aidons à la prendre.</p>
          </div>
   
          <div className='mb-10 lg:mb-0 timeCard timeCard2 scroll w-full' data-rate='-0.1' data-direction='vertical'>
            <Image
              src="/assets/images/Photos cabinet/DSCF8516.jpg"
              alt="Défendre"
              ...
              sizes="(max-width: 768px) 100vw"
            />
            <p className="text-lg md:text-xl lg:text-2xl font-normal leading-1 tracking-tight text-gray-900 text-justify px-3 mt-5 mb-8 text-wrap"><strong className='text-custom-purple font-bold'>Défendre</strong> un contrat, une réputation, un avenir professionnel. Faire valoir vos droits, avec méthode et détermination. C’est notre métier et notre engagement.</p>
          </div>
          ...
          <div>
           ...
           <div className='mb-10 lg:mb-0 timeCard timeCard3 scroll w-full' data-rate='-0.1' data-direction='vertical'>
            <Image
              src="/assets/images/Photos cabinet/DSCF8606.jpg"
              alt="Réussir"
              ...
              sizes="(max-width: 768px) 100vw"
            />
            <p className="text-lg md:text-xl lg:text-2xl font-normal leading-1 tracking-tight text-gray-900 text-justify px-3 mt-5 text-wrap"><strong className='text-custom-purple font-bold'>Réussir</strong>, c’est obtenir une issue juste, efficace, durable. C’est sortir d’un conflit en ayant gardé le cap. C’est transformer un risque en solution. Nous y travaillons, avec vous.</p>
          </div>
