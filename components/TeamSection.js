        ...
        {teamMembers.map((member, index) => (
          ...
          >
            ...
            <div className="relative w-full h-full">
              ...
              {/* Overlay sombre */}
              <div
                className="absolute inset-0 bg-black/70 text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col items-center justify-center px-4"
              >
                {/* Spécialité passée telle quelle en JSX */}
                {member.specialty}
              </div>
            </div>
            ...
            <div className="absolute bottom-0 p-4 bg-white w-full">
              ...
              <a href={member.linkedinUrl} className="text-gray-400 cursor-pointer" target="_blank">
