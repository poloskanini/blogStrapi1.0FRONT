...
const singleTitle = "Clause de confidentialité"
const titlePage = "Menezes Avocat - Clause de confidentialité"
const hrefPage = "/clause-de-confidentialite"

export default function clauseDeConfidentialite() {
      ...
      <Container>
        ...
        <Reveal>
          <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-12 gap-y-16 lg:mx-0 lg:min-w-full lg:max-w-none lg:flex-none lg:gap-y-8 mb-32">
            <h1 class="text-2xl font-semibold mb-6">Clause de Confidentialité - MENEZES AVOCAT</h1>
